...
- Матрица смежности
  ...
  ![263px-6n-graph2.svg.png](img/263px-6n-graph2.svg.png)
  ![Untitled](img/Untitled%203.png)
  ![Матрица смежности для неориентированного (слева) и ориентированного (справа) графа.](img/Untitled%204.png)
...
- Обход в глубину(Depth-First Search)
  **Общий алгоритм**:
  ...
  - Поиск циклов в ориентированном графе (white, grey, black)
...
- Алгоритм Дейкстры — Поиск кратчайшего(длинны) пути
  **Общий алгоритм:**
  ...
  1. объявить массивы посещенных вершин и дистанций до вершин
  2. инициализировать начальную дистанцию
